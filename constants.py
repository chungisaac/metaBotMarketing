...
PROMPT_TEMPLATE = Template("Prepare a facebook post to promote Clarifai's $highlight. Only output the raw text of the example. Do not include instructions. Include the hashtags '$hashtags'. Include the relevant link $optional `$link`. Limit the entire example to 2000 characters including the link.")
PROMOTION_HASHTAG_LINK_TUPLES = [
    ("hackathon with @lablab.ai", "#llms", "to register", "https://lablab.ai/event/llama-2-hackathon-with-clarifai"),
